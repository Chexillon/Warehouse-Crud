          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ url('finished/incoming')}}" class="nav-link">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ url('child/incoming')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>In Coming</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ url('child/outgoing')}}" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Out Going</p>
                  </a>
                </li>
...
@endif              
        <table class="table table-light">
            <h5 class="p-3 bg-dark text-white rounded fw-bold text-break">Out Going Child Part & Komponen</h5>
