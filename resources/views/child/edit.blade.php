        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ url('child/'.$data->id)}}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body container">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="text" name="nama_supplier" value="{{ $data->nama_supplier }}" placeholder="Nama supplier" >
                  </div>
                  {{-- <div class="form-group">
